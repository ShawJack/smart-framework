...
public class ClassUtil {
    ...
    private static void addClass(Set<Class<?>> classeSet, String packageName, String packagePath){
        ...
        for(File file : files){
            ...
            if(file.isFile()){
                ...
                String newPackageName = fileName;
                if(StringUtil.isNotEmpty(packageName)){
                    newPackageName = packageName + "." + newPackageName;
                }

                String newPackagePath = fileName;
                if(StringUtil.isNotEmpty(packagePath)){
                    newPackagePath = packagePath + "/" + newPackagePath;
                }

                addClass(classeSet, newPackageName, newPackagePath);
            }
        }
    }
    ...
    @Test
    public void test(){
        getClassSet("org.apache.commons.lang3");
    }
